...
import { RedactionReviewScore } from '../../models/redaction-review';

/**
 * Evaluator Workspace (TEP member view).
 *
 * Assigned proposals only (Section M factor-by-factor; narrative
 * required). Mirrors FAR 15.305 redactionReview discipline + Item 3
  ...
  template: `
    <div class="page-header">
      <div>
        ...
        <div class="subtitle">{{ role.current.displayName }} · Eval {{ redactionReview.id }} · FAR 15.305</div>
      </div>
      <a [routerLink]="['/redaction-review', redactionReview.id, 'consensus']"><button class="secondary">Consensus view →</button></a>
    </div>
    ...
    <div class="card">
      ...
      <table>
        <thead>
          <tr>
            <th>Proposal</th>
            <th *ngFor="let f of redactionReview.factors">
        ...
        <tbody>
          <tr *ngFor="let p of proposals">
            ...
            <td *ngFor="let f of redactionReview.factors">
