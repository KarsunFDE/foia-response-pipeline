      ...
      <div class="card">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>foia-request-service</td><td><code>:latest</code></td><td><span class="badge urgent">UNPINNED</span></td></tr>
            <tr><td>redaction-review-service</td><td><code>:latest</code></td><td><span class="badge urgent">UNPINNED</span></td></tr>
