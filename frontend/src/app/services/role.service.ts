...
const STORAGE_KEY = 'foia-response-pipeline:active-role';

/**
 * Mock role-switcher.
 *
 * Production resolves role from validated JWT (`role` claim) in the
 * API gateway. foia-response-pipeline main currently has Debt Item 1 (JWT
 ...
 * the legacy `foia-request-service` for the W4 walkthrough); never use
 * in production.
 */
