    ...
    return [
      {
        ...
        link: '/foia_requests/sol-0142/amendments',
      ...
      },
      {
        ...
        recipientRole: 'contracting_officer',
        link: '/foia_requests/sol-0203/proposals',
      ...
      },
      {
        ...
        body: 'RedactionReview EVAL-2026-0142 — 3 of 6 factors scored.',
        recipientRole: 'evaluator',
        link: '/redaction_review/workspace',
