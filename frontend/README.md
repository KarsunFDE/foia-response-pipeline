...
**except** the one component that hardcodes the foia-request-service URL
directly (Item 8).

## Brownfield-debt items present in this service

- **Item 8** — `FoiaRequestListComponent` hardcodes `http://localhost:8081/api/foia-requests`
...
- **Item 9 reinforcement** — `FoiaRequestCreateComponent` form has no
