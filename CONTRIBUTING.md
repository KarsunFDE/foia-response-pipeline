# Contributing to foia-response-pipeline

`foia-response-pipeline` is the **trainer brownfield** for the Karsun-FDE 6-week
...
| 2    | Audit-log race in foia-request-service       | **W3 multi-agent** or **W5-Wed** (AIOps gov) |
| 3    | Missing circuit breaker (eval → foia_request)| **W4-Thu** (reliability) |
