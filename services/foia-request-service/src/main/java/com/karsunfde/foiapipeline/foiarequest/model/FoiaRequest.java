...
/**
 * FoiaRequest document. Expanded W1 (was just id/title/description/status)
 ...
 */
@Document(collection = "foiaRequests")
public class FoiaRequest {
     ...
     * unsanitized; feeds /draft-foia-request + /draft-amendment prompts.
     */
