...
/**
 * Local async audit emitter for redaction-review-service. Mirrors the
 * foia-request-service Item 2 pattern — log-only fan-out here (no separate
 * Mongo collection in this service; the canonical audit_events collection
 * lives in foia-request-service and would be reached via cross-service call
 ...
 *   - Item 6 — logs traceId key (mismatched with foia-request-service +
 *     api-gateway).
 */
@Component
